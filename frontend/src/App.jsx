...
{`SELECT * FROM (
  SELECT 
    ...
    AVG(cq.valor_depois - cq.valor_antes) as variacao_media,
    AVG(((cq.valor_depois - cq.valor_antes) / NULLIF(cq.valor_antes, 0)) * 100) as melhora_percentual_media,
    DENSE_RANK() OVER(PARTITION BY cq.parametro_ajustado ORDER BY ABS(AVG(cq.valor_depois - cq.valor_antes)) DESC) as rank_impacto
  ...
  GROUP BY cq.parametro_ajustado, c.id_calibracao, c.tipo_calibracao, p.nome, c.data_hora_inicio
) ranked
